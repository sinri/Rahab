package io.github.sinri.rahab.v4a.wormhole;

import io.github.sinri.keel.Keel;
import io.github.sinri.keel.core.logger.KeelLogLevel;
import io.github.sinri.keel.core.logger.KeelLogger;
import io.github.sinri.keel.verticles.KeelVerticle;
import io.github.sinri.rahab.v4a.wormhole.transform.WormholeTransformer;
...
class WormholeWorkerVerticle extends KeelVerticle {
    ...
    private final AtomicReference<NetSocket> atomicRemoteSocket = new AtomicReference<>();
    ...
    private void execute() {
        ...
        localSocket
                .handler(rawBufferFromLocal -> {
                    ...
                    wormholeLogger.text(KeelLogLevel.DEBUG, Keel.stringHelper().bufferToHexMatrix(rawBufferFromLocal, 40), System.lineSeparator());
                    wormholeLogger.text(KeelLogLevel.DEBUG, rawBufferFromLocal.toString(), System.lineSeparator());
                            ...
                            for (var buffer : bufferList) {
                                atomicRemoteSocket.get().write(buffer)
                                        .onSuccess(v -> {
                                            ...
                                            wormholeLogger.text(KeelLogLevel.DEBUG, Keel.stringHelper().bufferToHexMatrix(buffer, 40), System.lineSeparator());
                                            wormholeLogger.text(KeelLogLevel.DEBUG, buffer.toString(), System.lineSeparator());
                                        })
                                        .onFailure(throwable -> {
                ...
                .compose(remoteSocket -> {
                    ...
                    atomicRemoteSocket.get()
                            .handler(rawBufferFromRemote -> {
                                ...
                                wormholeLogger.text(KeelLogLevel.DEBUG, Keel.stringHelper().bufferToHexMatrix(rawBufferFromRemote, 40), System.lineSeparator());
                                wormholeLogger.text(KeelLogLevel.DEBUG, rawBufferFromRemote.toString(), System.lineSeparator());
    ...
    public void stop() throws Exception {
        ...
        if (this.atomicRemoteSocket.get() != null) {
            this.atomicRemoteSocket.get().close();
        }
    }
}
